...
class PaymentStatusUpdatedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $loginUrl = route('login'); // Laravel route to login
                    ...
                    ->html("
                        ...
                        <body style=\"font-family: Arial, sans-serif; background-color: #f4f4f7; padding: 20px;\">
                            <div style=\"max-width: 600px; margin: auto; background-color: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);\">
                                ...
                                <p>We wanted to inform you that your payment of <strong>\${$amount}</strong> has been updated to <strong>{$status}</strong>.</p>
                                <p>If you have any questions or need assistance, please log in to your account:</p>
                                <p>Thank you.</p>
